      ...
      <form onSubmit={onSubmit} className="space-y-8">
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            className={`flex-1 bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 text-white py-4 rounded-xl font-semibull text-lg transition-all duration-300 ease-in-out transform hover:scale-[1.02] ${
        ...
        <div className="text-xs text-gray-500 text-center">
          Form Status:{" "}
          {!isDirty ? "No changes" : !isValid ? "Invalid" : "Ready to submit"}
        </div>
      </form>
    </Modal>
  );
